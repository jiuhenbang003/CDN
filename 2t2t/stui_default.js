...
var stui = {
	...
	'mobile': {
		'headroom': function() {
			$.getScript("https://cdn.jsdelivr.net/gh/jiuhenbang003/cdn/2t2t/headroom.min.js", function() {
				$("#header-top", function() {
		...
		'slide': function() {
			$.getScript("https://cdn.jsdelivr.net/gh/jiuhenbang003/cdn/2t2t/flickity.pkgd.min.js", function() {
	...
	'images': {
		'lazyload': function() {
			$.getScript("https://cdn.jsdelivr.net/gh/jiuhenbang003/cdn/2t2t/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 300,
					failurelimit: 15,
